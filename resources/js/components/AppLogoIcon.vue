...
<template>
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2200 2200" :class="className" v-bind="$attrs">
        <g>
            <!-- Main wallet body -->
            <path fill="currentColor" d="M1445.322,1261.727v97.661c0,60.069,48.696,108.765,108.765,108.765h233.631
            ...
            <!-- Card slot and button -->
            <path fill="currentColor" d="M1823.239,1182.962h-268.737c-43.732,0-79.183,35.452-79.183,79.183v96.823
            ...
            <!-- Cards with blue accent -->
            <path fill="#258AEF" d="M1538.076,505.081L657.383,719.964h958.744V566.378
                C1616.127,525.478,1577.811,495.386,1538.076,505.081z"/>
            <path fill="#3064B7" d="M1410.236,505.392l-879.44,214.571l756.94-386.921c36.29-18.86,80.66,1.27,90.37,41
                L1410.236,505.392z"/>
        </g>
    </svg>
</template>
